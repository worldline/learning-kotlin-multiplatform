...
<span class="token keyword">class</span> <span class="token function">QuizRepository</span><span class="token punctuation">(</span>sqlDriver<span class="token operator">:</span> SqlDriver<span class="token punctuation">)</span>  <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details>`,14),v={class:"custom-container tip"},m=n("p",{class:"custom-container-title"},"More databases options",-1),b={href:"https://github.com/realm/realm-kotlin",target:"_blank",rel:"noopener noreferrer"},h=n("code",null,"Realm kotlin",-1),w={href:"https://github.com/xxfast/KStore",target:"_blank",rel:"noopener noreferrer"},y=n("p",null,[n("strong",null,"✅ If everything is fine, go to the next chapter →")],-1),g=n("h2",{id:"📖-further-reading",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#📖-further-reading","aria-hidden":"true"},"#"),s(" 📖 Further reading")],-1),f={href:"https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-ktor-sqldelight.html",target:"_blank",rel:"noopener noreferrer"},q={href:"https://github.com/cashapp/sqldelight",target:"_blank",rel:"noopener noreferrer"};function E(S,L){const a=o("ExternalLinkIcon");return i(),c("div",null,[r,n("blockquote",null,[n("p",null,[s("Refer to the multiplatform implementation of SQLDelight in official Github pages 👉 "),n("a",d,[s("https://cashapp.github.io/sqldelight/2.0.0/multiplatform_sqlite/"),t(a)])])]),k,n("div",v,[m,n("p",null,[s("For not using SQLight ORM, you can use "),n("a",b,[h,t(a)]),s(" or "),n("a",w,[s("KStore"),t(a)])])]),y,g,n("ul",null,[n("li",null,[n("a",f,[s("SQL Delight tutorial (obsolete)"),t(a)])]),n("li",null,[n("a",q,[s("SQL Delight lib "),t(a)])])])])}const Q=p(u,[["render",E],["__file","index.html.vue"]]);export{Q as default};
